...
// /___/   /\     Timestamp : 01/30/2025 20:49:04
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/EE533_lab3/EE533_lab3/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   CB8CLE_MXILINX_dropfifo XLXI_6 (.C(clk), 
                                   .CE(XLXN_34), 
                                   .CLR(rst), 
                                   .D(XLXN_7[7:0]), 
                                   .L(XLXN_13), 
   ...
   CB8CE_MXILINX_dropfifo XLXI_7 (.C(clk), 
                                  .CE(XLXN_24), 
                                  .CLR(rst), 
                                  .CEO(), 
                                  .Q(XLXN_9[7:0]), 
   ...
   COMP8_MXILINX_dropfifo XLXI_10 (.A(XLXN_9[7:0]), 
                                   .B(XLXN_7[7:0]), 
                                   .EQ(XLXN_23));
   // synthesis attribute HU_SET of XLXI_10 is "XLXI_10_20"
   reg9B XLXI_11 (.ce(XLXN_38), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(XLXN_18[71:0]));
   mem_9B XLXI_31 (.addra(waddr[7:0]), 
                   .addrb(XLXN_9[7:0]), 
                   .clka(clk), 
                   .clkb(clk), 
                   .dina(XLXN_18[71:0]), 
   ...
   OR2 XLXI_32 (.I0(XLXN_2), 
                .I1(XLXN_1), 
                .O(XLXN_3));
   AND2B1 XLXI_33 (.I0(XLXN_13), 
                   .I1(XLXN_3), 
                   .O(XLXN_39));
   AND3B2 XLXI_34 (.I0(XLXN_23), 
                   .I1(XLXN_21), 
                   .I2(fiforead), 
                   .O(XLXN_24));
